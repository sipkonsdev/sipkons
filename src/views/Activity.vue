  ...
  <div>
    ...
    <div class="sm:grid sm:grid-cols-4 sm:gap-4">
      <div class="flex justify-end sm:col-span-3 sm:flex sm:justify-start p-2">
        <button class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-5 py-3 text-base font-medium text-white hover:bg-indigo-700" @click="toAddPage">Tambah Kegiatan</button>
      </div>
